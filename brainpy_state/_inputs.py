...
class PoissonEncoder(brainstate.nn.Dynamics):
    ...
    >>> encoder = brainpy_state.state.PoissonEncoder(10)
    >>>
    ...
    >>> neuron_layer = brainpy_state.state.LIF(10)
...
class PoissonInput(brainstate.nn.Module):
    ...
    >>> neuron = brainpy_state.state.LIF(100)
    >>> neuron.init_state(batch_size=1)
    >>>
    >>> # Add Poisson input to all neurons
    >>> poisson_in = brainpy_state.state.PoissonInput(
    ...     target=neuron.V,
    ...     indices=None,
    ...     num_input=200,
    ...     freq=50 * u.Hz,
    ...
    >>> specific_input = brainpy_state.state.PoissonInput(
    ...     target=neuron.V,
    ...     indices=indices,
    ...     num_input=50,
    ...     freq=100 * u.Hz,
...
def poisson_input(
    ...
    >>> brainpy_state.state.poisson_input(
    ...     freq=50 * u.Hz,
    ...     num_input=200,
    ...     weight=0.1 * u.mV,
    ...     target=V
