...
formal send-view seam** (:func:`brainpy_state._nest_network.send_steps_from_pre` /
:func:`brainpy_state._nest_network.weight_recorder_events`), the parts those ad-hoc
...
from brainpy_state._nest_network import send_steps_from_pre, weight_recorder_events
...
from brainpy_state._nest_validation import _stdp_dopamine_drive as ddrv
from brainpy_state._nest_validation import _clopath_drive as cdrv
...
class Row:
    ...
    model : str
        ...
        :func:`brainpy_state._nest_validation._stdp_drive.nest_pair_run`.
    rule : callable
