...
# Legacy imperative (NEST history-buffer) send() implementation, preserved as the
# no-NEST reference oracle; the active public ``urbanczik_synapse`` is now the
# spec+rule rebuild on VoltageCoupledPlasticProj.
from brainpy_state._nest._legacy_urbanczik_synapse import urbanczik_synapse
