...
Rebuilt as a thin reuse of :class:`~brainpy_state._nest.stdp_synapse.stdp_synapse`
on the frozen :class:`~brainpy_state._network._event_plastic.EventPlasticProj`
...
class stdp_synapse_hom(stdp_synapse):
    ...
    Functionally identical to :class:`~brainpy_state._nest.stdp_synapse.stdp_synapse`:
    ...
    *common* (homogeneous across the model); here every projection edge already
    ...
    weight, delay, receptor_type, tau_plus, tau_minus, lambda_, alpha, mu_plus, mu_minus, Wmax, Kplus
        See :class:`~brainpy_state._nest.stdp_synapse.stdp_synapse`.
