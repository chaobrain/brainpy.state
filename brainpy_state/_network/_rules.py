...
class _ExplicitEdges(ConnRule):
    ...
    Lets :meth:`~brainpy_state._network._simulator.Simulator.tripartite_connect`
    feed a single shared edge sample into the existing
    :class:`~brainpy_state._network._event_proj.EventProjection` /
...
class _ThirdFactorBernoulliWithPool:
    ...
    :meth:`~brainpy_state._network._simulator.Simulator.tripartite_connect`.
    """
    __module__ = 'brainpy.state'
...
def third_factor_bernoulli_with_pool(*, p: float, pool_size: int, pool_type: str):
    ...
    :meth:`~brainpy_state._network._simulator.Simulator.tripartite_connect`: for
