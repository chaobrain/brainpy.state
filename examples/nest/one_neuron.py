...
Run:  python examples/nest/one_neuron.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/one_neuron.png", dpi=100)
        print("  wrote examples/nest/one_neuron.png")
    except ImportError:
