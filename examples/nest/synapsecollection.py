...
:class:`~brainpy_state._network._connection_introspection.SynapseCollection`:
...
Run:  PYTHONPATH=. python examples/nest/synapsecollection.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/synapsecollection.png", dpi=100)
        print("  wrote examples/nest/synapsecollection.png")
    except ImportError:
