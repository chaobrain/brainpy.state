...
Run ``python examples/nest/gap_junctions_inhibitory_network.py`` to simulate and plot a
...
from examples.nest.gap_junctions_two_neurons import resting_gating
...
def main():  # pragma: no cover - manual full-scale demo driver (I/O + matplotlib)
    ...
    plt.tight_layout()
    plt.savefig('examples/nest/gap_junctions_inhibitory_network.png', dpi=100)
    print('  saved examples/nest/gap_junctions_inhibitory_network.png')
