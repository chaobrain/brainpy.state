# examples/nest/astrocyte_single.py
...
Run:  python examples/nest/astrocyte_single.py
"""
import jax
import brainstate
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/astrocyte_single.png", dpi=100)
        print("  wrote examples/nest/astrocyte_single.png")
    except ImportError:
