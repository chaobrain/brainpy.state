...
:class:`~examples.nest.pong.GameOfPong`. Each turn the ball's y-cell is presented to
...
Run::
    ...
    PYTHONPATH=. python examples/nest/pong_run.py --quick
    PYTHONPATH=. python examples/nest/pong_run.py --players rn dn --runs 200
...
from examples.nest.pong_networks import PongNetRSTDP, PongNetDopa
...
def main():
    ...
    parser.add_argument('--out', type=str, default='examples/nest/pong_run.png',
