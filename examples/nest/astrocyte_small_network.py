...
Run:  python examples/nest/astrocyte_small_network.py
"""
import jax
import brainstate
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/astrocyte_small_network.png", dpi=100)
        print("  wrote examples/nest/astrocyte_small_network.png")
    except ImportError:
