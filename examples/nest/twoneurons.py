...
Run:  python examples/nest/twoneurons.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.legend(loc=3)
        plt.tight_layout()
        plt.savefig("examples/nest/twoneurons.png", dpi=100)
        print("  wrote examples/nest/twoneurons.png")
    except ImportError:
