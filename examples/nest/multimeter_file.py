# examples/nest/multimeter_file.py
...
does not yet provide (a documented follow-up; see ``CONTEXT.md`` Lessons). This
...
Run:  python examples/nest/multimeter_file.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig("examples/nest/multimeter_file.png", dpi=100)
        print("  wrote examples/nest/multimeter_file.png")
    except ImportError:
