# examples/nest/ei_clustered_network.py
...
Run:  PYTHONPATH=. python examples/nest/ei_clustered_network.py
"""
import jax
import brainstate
...
def psc_to_psp(tau_m, tau_syn, c_m=1.0, e_l=0.0):
    ...
    .. code-block:: python
        ...
        >>> from examples.nest.ei_clustered_network import psc_to_psp
...
def cluster_weights(rep, rj, q):
    ...
    .. code-block:: python
        ...
        >>> from examples.nest.ei_clustered_network import cluster_weights
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/ei_clustered_network.png", dpi=100)
        print("  wrote examples/nest/ei_clustered_network.png")
    except ImportError:
