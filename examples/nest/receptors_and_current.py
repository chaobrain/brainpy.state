# examples/nest/receptors_and_current.py
...
Run:  PYTHONPATH=. python examples/nest/receptors_and_current.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.legend(loc=0)
        plt.tight_layout()
        plt.savefig("examples/nest/receptors_and_current.png", dpi=100)
        print("  wrote examples/nest/receptors_and_current.png")
    except ImportError:
