# examples/nest/brunel_exp_multisynapse.py
...
Run:  python examples/nest/brunel_exp_multisynapse.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/brunel_exp_multisynapse_raster.png", dpi=100)
        print("  wrote examples/nest/brunel_exp_multisynapse_raster.png")
    except ImportError:
