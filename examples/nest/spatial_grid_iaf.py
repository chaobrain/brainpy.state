# examples/nest/spatial_grid_iaf.py
...
Run:  PYTHONPATH=. python examples/nest/spatial_grid_iaf.py
"""
import jax
import brainstate
...
def main():
    ...
    plt.tight_layout()
    plt.savefig('examples/nest/spatial_grid_iaf.png', dpi=100)
    print('  wrote examples/nest/spatial_grid_iaf.png')
