...
Run:  PYTHONPATH=. python examples/nest/izhikevich.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/izhikevich.png", dpi=100)
        print("  wrote examples/nest/izhikevich.png")
    except ImportError:
