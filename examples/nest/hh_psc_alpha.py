...
Run:  python examples/nest/hh_psc_alpha.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/hh_psc_alpha.png", dpi=100)
        print("  wrote examples/nest/hh_psc_alpha.png")
    except ImportError:
