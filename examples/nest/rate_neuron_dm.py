# examples/nest/rate_neuron_dm.py
...
Run:  PYTHONPATH=. python examples/nest/rate_neuron_dm.py
"""
import jax
import brainstate
...
def main():  # pragma: no cover
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('examples/nest/rate_neuron_dm.png', dpi=100)
        print('  wrote examples/nest/rate_neuron_dm.png')
    except ImportError:
