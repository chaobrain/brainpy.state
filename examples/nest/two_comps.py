...
Run:  PYTHONPATH=. python examples/nest/two_comps.py
"""
import jax
import brainstate
...
from brainpy_state import Simulator, cm_default, spike_generator, multimeter
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/two_comps.png", dpi=100)
        print("  wrote examples/nest/two_comps.png")
    except ImportError:
