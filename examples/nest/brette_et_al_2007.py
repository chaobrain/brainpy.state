...
Run:  python examples/nest/brette_et_al_2007.py
...
def connection_counts(ne=NE, ni=NI, epsilon=EPSILON):
    ...
    .. code-block:: python
        ...
        >>> from examples.nest.brette_et_al_2007 import connection_counts
...
def population_rate(raster, n_rec, simtime_ms):
    ...
    .. code-block:: python
        ...
        >>> import numpy as np
        >>> from examples.nest.brette_et_al_2007 import population_rate
