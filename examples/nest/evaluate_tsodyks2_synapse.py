# examples/nest/evaluate_tsodyks2_synapse.py
...
Run:  python examples/nest/evaluate_tsodyks2_synapse.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.savefig("examples/nest/evaluate_tsodyks2_synapse.png", dpi=100)
        print("  wrote examples/nest/evaluate_tsodyks2_synapse.png")
    except ImportError:
