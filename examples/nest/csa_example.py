...
* ``csa.random * (csa.gaussian(sigma, cutoff) * d)`` (the *spatial* CSA demo,
  ...
  ``examples/nest/spatial_csa.py`` with
...
See Also
--------
examples/nest/spatial_csa.py : the spatial CSA demo ported with the native spatial rule.

Run:  PYTHONPATH=. python examples/nest/csa_example.py
"""
import jax
import brainstate
...
def main():
    ...
    print('  for spatial CSA connectivity, see examples/nest/spatial_csa.py')
