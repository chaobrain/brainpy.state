# examples/nest/clopath_synapse_spike_pairing.py
...
Run:  python examples/nest/clopath_synapse_spike_pairing.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.savefig("examples/nest/clopath_synapse_spike_pairing.png", dpi=100)
        print("  wrote examples/nest/clopath_synapse_spike_pairing.png")
    except ImportError:
