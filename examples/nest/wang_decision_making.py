...
Run:  python examples/nest/wang_decision_making.py
...
def main():   # pragma: no cover - manual full-scale demo driver (I/O + matplotlib)
    ...
    try:
        ...
        plt.savefig('examples/nest/wang_decision_making_rates.png', dpi=100)
        print("  wrote examples/nest/wang_decision_making_rates.png")
    except ImportError:
