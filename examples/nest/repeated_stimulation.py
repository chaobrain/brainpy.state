# examples/nest/repeated_stimulation.py
...
Run:  PYTHONPATH=. python examples/nest/repeated_stimulation.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/repeated_stimulation_raster.png", dpi=100)
        print("  wrote examples/nest/repeated_stimulation_raster.png")
    except ImportError:
