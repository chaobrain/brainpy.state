...
Run:  python examples/nest/brunel_delta.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/brunel_delta_raster.png", dpi=100)
        print("  wrote examples/nest/brunel_delta_raster.png")
    except ImportError:
