# examples/nest/evaluate_quantal_stp_synapse.py
...
Run:  python examples/nest/evaluate_quantal_stp_synapse.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/evaluate_quantal_stp_synapse.png", dpi=100)
        print("  wrote examples/nest/evaluate_quantal_stp_synapse.png")
    except ImportError:
