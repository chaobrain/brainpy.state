# examples/nest/sensitivity_to_perturbation.py
...
Run:  PYTHONPATH=. python examples/nest/sensitivity_to_perturbation.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/sensitivity_to_perturbation.png", dpi=100)
        print("  wrote examples/nest/sensitivity_to_perturbation.png")
    except ImportError:
