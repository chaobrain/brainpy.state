# examples/nest/spatial_3d_gauss.py
...
Run:  PYTHONPATH=. python examples/nest/spatial_3d_gauss.py
"""
import jax
import brainstate
...
def main():
    ...
    plt.tight_layout()
    plt.savefig('examples/nest/spatial_3d_gauss.png', dpi=100)
    print('  wrote examples/nest/spatial_3d_gauss.png')
