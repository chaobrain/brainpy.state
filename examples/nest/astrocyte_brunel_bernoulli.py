...
Run:  python examples/nest/astrocyte_brunel_bernoulli.py
"""
import jax
import brainstate
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/astrocyte_brunel_bernoulli.png", dpi=100)
        print("  wrote examples/nest/astrocyte_brunel_bernoulli.png")
    except ImportError:
