# examples/nest/artificial_synchrony.py
...
Run:  PYTHONPATH=. python examples/nest/artificial_synchrony.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.savefig("examples/nest/artificial_synchrony.png", dpi=100)
        print("  wrote examples/nest/artificial_synchrony.png")
    except ImportError:
