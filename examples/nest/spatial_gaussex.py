# examples/nest/spatial_gaussex.py
...
Run:  PYTHONPATH=. python examples/nest/spatial_gaussex.py
"""
import jax
import brainstate
...
def main():
    ...
    plt.tight_layout()
    plt.savefig('examples/nest/spatial_gaussex.png', dpi=100)
    print('  wrote examples/nest/spatial_gaussex.png')
