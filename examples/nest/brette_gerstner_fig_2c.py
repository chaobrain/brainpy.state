# examples/nest/brette_gerstner_fig_2c.py
...
Run:  python examples/nest/brette_gerstner_fig_2c.py
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest/brette_gerstner_fig_2c.png", dpi=100)
        print("  wrote examples/nest/brette_gerstner_fig_2c.png")
    except ImportError:
