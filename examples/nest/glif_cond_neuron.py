# examples/nest/glif_cond_neuron.py
...
Run:  python examples/nest/glif_cond_neuron.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/glif_cond_neuron.png", dpi=100)
        print("  wrote examples/nest/glif_cond_neuron.png")
    except ImportError:
