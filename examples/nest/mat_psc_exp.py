...
Run:  PYTHONPATH=. python examples/nest/mat_psc_exp.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/mat_psc_exp.png", dpi=100)
        print("  wrote examples/nest/mat_psc_exp.png")
    except ImportError:
