# examples/nest/BrodyHopfield.py
...
Run:  PYTHONPATH=. python examples/nest/BrodyHopfield.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest/BrodyHopfield.png", dpi=100)
        print("  wrote examples/nest/BrodyHopfield.png")
    except ImportError:
