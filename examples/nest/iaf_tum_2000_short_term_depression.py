# examples/nest/iaf_tum_2000_short_term_depression.py
...
Run:  PYTHONPATH=. python examples/nest/iaf_tum_2000_short_term_depression.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('examples/nest/iaf_tum_2000_short_term_depression.png', dpi=100)
        print('  wrote examples/nest/iaf_tum_2000_short_term_depression.png')
    except ImportError:
