# examples/nest_like/plot_weight_matrices.py
...
Run:  PYTHONPATH=. python examples/nest_like/plot_weight_matrices.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest_like/plot_weight_matrices.png", dpi=100)
        print("  wrote examples/nest_like/plot_weight_matrices.png")
    except ImportError:
