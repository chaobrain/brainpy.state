# examples/nest_like/one_neuron_with_noise.py
...
Run:  python examples/nest_like/one_neuron_with_noise.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/one_neuron_with_noise.png", dpi=100)
        print("  wrote examples/nest_like/one_neuron_with_noise.png")
    except ImportError:
