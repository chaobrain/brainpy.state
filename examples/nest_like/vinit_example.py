# examples/nest_like/vinit_example.py
...
Run:  python examples/nest_like/vinit_example.py
"""
import jax
import brainstate
...
def main():
    ...
    if have_plt:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/vinit_example.png", dpi=100)
        print("  wrote examples/nest_like/vinit_example.png")
    else:
