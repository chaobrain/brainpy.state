...
Run:  python examples/nest_like/testiaf.py
"""
import jax
import brainstate
...
def main():
    ...
    if have_plt:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/testiaf.png", dpi=100)
        print("  wrote examples/nest_like/testiaf.png")
    else:
