# examples/nest_like/urbanczik_synapse_example.py
...
Run:  python examples/nest_like/urbanczik_synapse_example.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        axB.legend()
        plt.tight_layout()
        plt.savefig("examples/nest_like/urbanczik_synapse_example.png", dpi=100)
        print("  wrote examples/nest_like/urbanczik_synapse_example.png")
    except ImportError:
