# examples/nest_like/aeif_cond_beta_multisynapse.py
...
Run:  python examples/nest_like/aeif_cond_beta_multisynapse.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest_like/aeif_cond_beta_multisynapse.png", dpi=100)
        print("  wrote examples/nest_like/aeif_cond_beta_multisynapse.png")
    except ImportError:
