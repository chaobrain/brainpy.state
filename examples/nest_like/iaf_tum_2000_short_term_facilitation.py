# examples/nest_like/iaf_tum_2000_short_term_facilitation.py
...
Run:  PYTHONPATH=. python examples/nest_like/iaf_tum_2000_short_term_facilitation.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig('examples/nest_like/iaf_tum_2000_short_term_facilitation.png', dpi=100)
        print('  wrote examples/nest_like/iaf_tum_2000_short_term_facilitation.png')
    except ImportError:
