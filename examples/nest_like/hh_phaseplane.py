# examples/nest_like/hh_phaseplane.py
...
Run:  python examples/nest_like/hh_phaseplane.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/hh_phaseplane.png", dpi=100)
        print("  wrote examples/nest_like/hh_phaseplane.png")
    except ImportError:
