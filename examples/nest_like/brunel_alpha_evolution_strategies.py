# examples/nest_like/brunel_alpha_evolution_strategies.py
...
Run:  python examples/nest_like/brunel_alpha_evolution_strategies.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.savefig("examples/nest_like/brunel_alpha_evolution_strategies.png", dpi=100)
        print("  wrote examples/nest_like/brunel_alpha_evolution_strategies.png")
    except ImportError:
