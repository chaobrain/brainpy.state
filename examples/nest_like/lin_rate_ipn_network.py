# examples/nest_like/lin_rate_ipn_network.py
...
def main():  # pragma: no cover
    ...
    try:
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('examples/nest_like/lin_rate_ipn_network_rates.png', dpi=100)
        print('  wrote examples/nest_like/lin_rate_ipn_network_rates.png')
    except ImportError:
