# examples/nest_like/spatial_gabor.py
...
Run:  PYTHONPATH=. python examples/nest_like/spatial_gabor.py
"""
import jax
import brainstate
...
def main():
    ...
    plt.tight_layout()
    plt.savefig('examples/nest_like/spatial_gabor.png', dpi=100)
    print('  wrote examples/nest_like/spatial_gabor.png')
