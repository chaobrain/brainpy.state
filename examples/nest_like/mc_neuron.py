# examples/nest_like/mc_neuron.py
...
Run:  PYTHONPATH=. python examples/nest_like/mc_neuron.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest_like/mc_neuron.png", dpi=100)
        print("  wrote examples/nest_like/mc_neuron.png")
    except ImportError:
