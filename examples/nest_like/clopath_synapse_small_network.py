# examples/nest_like/clopath_synapse_small_network.py
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest_like/clopath_synapse_small_network.png", dpi=100)
        print("  wrote examples/nest_like/clopath_synapse_small_network.png")
    except ImportError:
