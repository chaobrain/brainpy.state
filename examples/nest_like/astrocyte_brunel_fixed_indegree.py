# examples/nest_like/astrocyte_brunel_fixed_indegree.py
...
Run:  python examples/nest_like/astrocyte_brunel_fixed_indegree.py
"""
import jax
import brainstate
...
from examples.nest_like.astrocyte_brunel_bernoulli import build
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/astrocyte_brunel_fixed_indegree.png", dpi=100)
        print("  wrote examples/nest_like/astrocyte_brunel_fixed_indegree.png")
    except ImportError:
