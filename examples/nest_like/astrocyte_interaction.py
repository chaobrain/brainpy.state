# examples/nest_like/astrocyte_interaction.py
...
Run:  python examples/nest_like/astrocyte_interaction.py
"""
import jax
import brainstate
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/astrocyte_interaction.png", dpi=100)
        print("  wrote examples/nest_like/astrocyte_interaction.png")
    except ImportError:
