# examples/nest_like/gif_population.py
...
Run:  PYTHONPATH=. python examples/nest_like/gif_population.py
"""
import jax
import brainstate
...
def main():
    ...
    try:
        ...
        fig.tight_layout()
        fig.savefig("examples/nest_like/gif_population.png", dpi=100)
        print("  wrote examples/nest_like/gif_population.png")
    except ImportError:
