# examples/nest_like/brette_gerstner_fig_3d.py
...
Run:  python examples/nest_like/brette_gerstner_fig_3d.py
...
def main():                                            # pragma: no cover - demo driver
    ...
    try:
        ...
        plt.tight_layout()
        plt.savefig("examples/nest_like/brette_gerstner_fig_3d.png", dpi=100)
        print("  wrote examples/nest_like/brette_gerstner_fig_3d.png")
    except ImportError:
