...
| [8 — CLI & visualization](./08-cli-and-viz.md)                        | §12                    | `bp-spec` CLI commands, visualization modes (graph, layers, matrix, params), renderers (Mermaid, Graphviz, HTML, Matplotlib). |
