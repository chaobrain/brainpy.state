...
| `eprop_learning_signal_connection` | missing | — | <https://nest-simulator.readthedocs.io/en/stable/models/eprop_learning_signal_connection.html> | — | Coordinate with neurons-gap.md e-prop entries |
| `eprop_learning_signal_connection_bsshslm_2020` | missing | — | <https://nest-simulator.readthedocs.io/en/stable/models/eprop_learning_signal_connection_bsshslm_2020.html> | — | Bellec 2020 variant |
| `eprop_synapse` | missing | — | <https://nest-simulator.readthedocs.io/en/stable/models/eprop_synapse.html> | — | core e-prop plasticity |
| `eprop_synapse_bsshslm_2020` | missing | — | <https://nest-simulator.readthedocs.io/en/stable/models/eprop_synapse_bsshslm_2020.html> | — | Bellec 2020 variant |
